...
* 6 Field Types:  Nothing to comply with.
  ...
  * 6.3 Scalar Field Types:  **TODO**  TODO declaration of fields of the following scalar types: integer numbers, ranges and real numbers; TODO Signed integers are supported by using the int declaration, TODO Hexadecimal values can be written using the 0x prefix, TODO Octal values using an extra 0; TODO a range type declaration, TODO possible to omit the minimum index in ranges, TODO keywords MIN and MAX instead of a numeral literal in one or both of the points conforming the range, TODO Hexadecimal and octal numbers can be used to specify the limits in a range, TODO Real number fields can be declared with the real type specifier; TODO The decimal separator is always the dot (.) character regardless of the locale setting; TODO Examples of fields of type real.
  * 6.4 String Field Types:  **TODO**  TODO line field type specifier can be used to restrict the value of a field to a single line; TODO Examples of fields of type line; TODO size field type specifier can be used to define the maximum number of characters; TODO hexadecimal and octal integer constants can also be used to specify field size; TODO Arbitrary restrictions can be defined by using regular expressions; TODO encoding of the identifier of ID cards in some country example; TODO slashes delimiting the re can be replaced; TODO regexp flavor supported in recfiles.
  * 6.5 Enumerated Field Types:  **TODO**  TODO Enumeration symbols are strings described by the following regexp (TODO really allow the dash character?); TODO symbols are separated by blank characters (including newlines); TODO possible to insert comments when describing an enum type, delimited by parenthesis pairs; TODO contents of the comments can be any character but parentheses; TODO Boolean fields, declared with the type specifier bool; TODO literals allowed in boolean fields.
  * 6.6 Date and Time Types:  **TODO**  TODO date field type specifier can be used to declare dates and times with synopsis; TODO LC_TIME and the TZ environment variables are ignored; TODO '1/10/2001' means January 10, 2001; TODO Relative times and dates (such as ‘1 day ago’).
  * 6.7 Other Field Types:  **TODO**  TODO Email field type specifier is used to declare electronic addresses with synopsis; TODO which e-mail address formats are supported? Full RFC... formats?; TODO Field field type specifier to store field names with synopsis; TODO uuid field type specifier with synopsis; TODO format of the uuids is specified as 32 hexadecimal digits, displayed in five groups separated by hyphens; TODO field type, viz, a foreign key of whatever type is defined for the primary key of the other record set.
...
* The inconsistency in the format of list of field names - once separated by comma, often times separated by space - is according to the GNU recutils manual.
