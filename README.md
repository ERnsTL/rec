...
* 2 The Rec Format:  Nothing to comply with.
  * 2.1 Fields:  Field example, Field name regular expression, Field name case-sensitive, TODO Valid field name examples, TODO Value of a field, TODO Escaping a newline (multi-line values).
