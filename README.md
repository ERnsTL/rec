...
* 2 The Rec Format:  Nothing to comply with.
  ...
  * 2.2 Records:  Record example, TODO Several fields in a record share the same name and/or field value (multi-fields), TODO size of a record, TODO Record separation.
